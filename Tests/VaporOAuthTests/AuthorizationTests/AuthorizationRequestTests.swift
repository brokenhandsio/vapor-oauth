...
class AuthorizationRequestTests: XCTestCase {
    ...
    let redirectURI = URI(string: "https://api.brokenhands.io/callback")
    ...
    func testThatAuthorizationCodeRequestCallsAuthoriseHandlerWithQueryParameters() async throws {
        ...
        _ = try await respondToOAuthRequest(responseType: responseType, clientID: clientID, redirectURI: redirectURI.string)
