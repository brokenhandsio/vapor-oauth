...
class AuthorizationCodeTokenTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        let testCode = OAuthCode(
            ...
            scopes: scopes,
            codeChallenge: testCodeChallenge, // Add PKCE parameter
            codeChallengeMethod: testCodeChallengeMethod // Add PKCE parameter
        )
    ...
    func testCorrectErrorCodeAndHeadersReturnedIfCodeWasNotIssuedByClient() async throws {
        let codeID = "1234567"
        let code = OAuthCode(codeID: codeID, clientID: testClientID, redirectURI: testClientRedirectURI, userID: "1", expiryDate: Date().addingTimeInterval(60), scopes: nil,  codeChallenge: nil, codeChallengeMethod: nil)
    ...
    func testThatNoScopeReturnedIfNoneSetOnCode() async throws {
        ...
        let newCode = OAuthCode(codeID: newCodeString, clientID: testClientID, redirectURI: testClientRedirectURI, userID: "1", expiryDate: Date().addingTimeInterval(60), scopes: nil, codeChallenge: nil, codeChallengeMethod: nil)
    ...
    func testThatRefreshTokenHasNoScopesIfNoneRequested() async throws {
        ...
        let newCode = OAuthCode(codeID: newCodeString, clientID: testClientID, redirectURI: testClientRedirectURI, userID: "user-ID", expiryDate: Date().addingTimeInterval(60), scopes: nil, codeChallenge: nil, codeChallengeMethod: nil)
        fakeCodeManager.codes[newCodeString] = newCode
